  ...
  <div class="menu-rodape">
    ...
    <div class="bd-menu-right" >
      ...
      <ul class="fonte-textos">
        <li><a href="<?= get_bloginfo('url') ?>/conceito/">Conceito</a></li>
...
<!-- Checagem de compatibilidade do navegador -->
<script type="text/javascript">
  var $buoop = {
...
if (isset($_GET['msg'])) {
  ...
  switch ($_GET['msg']) {
    ...
    case '1':
      $alerta = 'Seu email foi enviado com sucesso.';
      break;

    case '2':
      $alerta = 'Ocorreu um erro. Por favor, tente mais tarde ou entre em contato por outro meio no momento.';
      break;
  }
  ?>
  <!-- Mensagem do contato -->
